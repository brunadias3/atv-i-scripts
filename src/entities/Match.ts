...
export class Match {
    ...
    // cascade define que ao excluir o time as partidas serão excluídas
    ...
    @JoinColumn({
        ...
        foreignKeyConstraintName: "fk_id_host" // pode ser qualquer nome usado para você identificar a FK
    })
    host: Team;
